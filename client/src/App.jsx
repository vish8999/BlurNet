...
// Extract the dashboard content into its own component for the "/" route
const DashboardHome = () => (
  <>
    {/* Welcome Text */}
...
// Sidebar Navigation Component to handle active route styles
const SidebarNav = () => {
  const location = useLocation();
  
  const menuItems = [
    { name: 'Dashboard', path: '/' },
    { name: 'Live Monitoring', path: '/live' },
    ...
    <BrowserRouter>
      <div className="flex h-screen bg-[#0d0f14] text-slate-50 overflow-hidden font-sans">
        ...
        <div className="flex-1 flex flex-col z-10 w-full overflow-hidden">
          ...
          {/* Scrollable Main Area - Routes injected here */}
